...
- Multiple tests have been carried out to check if the wrong inputs would be entered by the user and the app will trigger an error.

![1504B68B-EC22-48EA-9ADC-8EB365EF347E_1_105_c](https://github.com/Mr-KulwinderSingh/healthy-games-healthy-kids/assets/124357266/cffc5688-d77a-4780-8d60-a95eb2eb43fe)
...
![1DE6546A-48BF-4D4C-A2B9-24F6BDAAB172_1_105_c](https://github.com/Mr-KulwinderSingh/healthy-games-healthy-kids/assets/124357266/fa8420f3-5198-432c-ab92-ffcf64ac2b70)
...
# Testing & Bugs #
- I got a list of errors while testing, All the known errors and bugs were removed (known errors i.e blank spaces, blank lines, trailing spaces, characters exceeding the limit of 80 etc.). No serious error or bugs were found when testing the code through [PEP8](https://pep8ci.herokuapp.com/) validator.
